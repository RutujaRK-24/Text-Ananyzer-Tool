      ...
      <div className="container-fluid p-0">
        <div className="row">
          <nav className="bg-secondary-subtle navbar shadow-sm">
            <Link to="/" className="navbar-brand" style={{ marginLeft: "5%" }}>
              Text Analyzer Tool
            </Link>
          </nav>
        </div>
        ...
        <div className="mt-4 row" style={boxCentent}>
          <div className="col-4">
